...
public class SeguridadWeb {
    ...
    //                        .hasRole("ADMIN");
    //                authz.requestMatchers("/", "/login", "/registrar", "/registro", "/servicio/registrar", "/servicio/registro")
    //                        .permitAll();
                    authz.requestMatchers("/css/**", "/js/**", "/img/**", "/**") // OJO EL "/**"" PERMITE ACCESO A TODAS LAS URL
                            .permitAll();
                    // authz.anyRequest()
                    // .authenticated();
                })
